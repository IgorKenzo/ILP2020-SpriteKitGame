            ...
            Level(grounds: [
                (Ground(color: .white, size: CGSize(width: 300, height: 30)), CGPoint(x: -620, y: 1050)),
                  ...
                  spikes: [
                    ...
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: -600, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: -500, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: -200, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: -100, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 0, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 100, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 200, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 500, y: 150)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 600, y: 150)),
                    ...
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: -100, y: 50)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 0, y: 50)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 100, y: 50)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 200, y: 50)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 500, y: 50)),
                    (StealthSpike(texture: SpriteLoader.shared.spike),CGPoint(x: 600, y: 50)),
